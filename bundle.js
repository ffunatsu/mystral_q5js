...
// node_modules/q5/q5.js
var require_q5 = __commonJS({
  "node_modules/q5/q5.js"(exports) {
...
`;
    ...
    Q5.Vector.direction = (v) => exports._$.atan2(v.y, v.x);
...
`;
      ...
      $._createPipeline = (opt) => {
        ...
        let module2;
        if (opt.module) module2 = opt.module;
        else {
          module2 = Q5.device.createShaderModule({
            label: label + "Shader",
...
// main.js
var import_q5 = __toESM(require_q5(), 1);
console.log("init");
